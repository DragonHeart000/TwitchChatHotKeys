package ninja.dragonheart.TwitchHotKeys.Styling;
...
public class StyleController {
	...
	public void previewCSS(){
		...
		stylerPane.getScene().getStylesheets().add(getClass().getResource("PreMades/" + pickSkinDropDown.getValue() + ".css").toExternalForm());
		System.out.println("PreMades/" + pickSkinDropDown.getValue() + ".css");
	}
